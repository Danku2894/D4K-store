...
const NewArrivals = () => {
  ...
  const fetchNewArrivals = async () => {
    try {
      ...
      // Gọi API lấy new arrivals (sorted by createdAt desc)
    ...
    <section className="py-16 bg-light-100">
      <div className="container-street">
        ...
        <div className="text-center mb-12 space-y-4">
          <div className="inline-block px-4 py-2 border-2 border-dark-950 mb-4">
            <span className="text-dark-950 font-bold text-sm uppercase tracking-widest">
              JUST DROPPED
            </span>
          </div>
          ...
          <div className="flex items-center justify-center space-x-2 pt-4">
            ...
            <div className="w-2 h-2 bg-dark-950"></div>
            <div className="w-16 h-1 bg-dark-950"></div>
            <div className="w-2 h-2 bg-street-red"></div>
          </div>
        </div>
